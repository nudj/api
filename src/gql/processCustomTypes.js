      ...
      case 'ObjectTypeDefinition':
        ...
        definition.fields.forEach((field) => {
          ...
          if (typeConfig.list) {
            ...
            fieldStrings.type.push(`${fieldNamePluralisms.singular}ByFilters(filters: ${fieldNamePluralisms.Singular}FilterInput): ${typeConfig.name}`)
            fieldStrings.type.push(`${fieldNamePluralisms.plural}ByFilters(filters: ${fieldNamePluralisms.Singular}FilterInput): [${typeConfig.name}!]`)
          }
